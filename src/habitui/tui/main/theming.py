...
class TextualThemeBridge:
    """Convert JSON themes to Textual Theme objects."""

    def __init__(self, themes_file_path: Path | None = None) -> None:
...
class TextualThemeManager:
    ...
    def __init__(self, app: HabiTUI, themes_file_path: Path | None = None) -> None:
    ...
    def _setup_default_themes(self) -> None:
        """Set default themes including rose_pine fallback."""
