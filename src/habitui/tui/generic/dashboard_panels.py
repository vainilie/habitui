...
class FlexibleContainer(Vertical):
    def __init__(
        ...
        **kwargs,
        ...
        classes = (
            f"flexible-container {css_classes}" if css_classes else "flexible-container"
        )
        super().__init__(id=element_id, classes=classes, **kwargs)
...
def example_usage() -> FlexibleContainer:
    ...
    stats_panel = create_info_panel(
        health_row,
        energy_row,
        title="Player Stats",
        title_icon="GAME_CONTROLLER",
    )
    ...
    return FlexibleContainer(
        stats_panel,
        readme_section,
        container_type="scrollable",
        title="Main Dashboard",
        title_icon="DASHBOARD",
    )
