...
class DateTimeHandler(BaseModel):
    """Handles various datetime formats and provides convenient conversions."""
    ...
    def utc_datetime(self) -> datetime | None:
        ...
        try:
            ...
            log.error("Unsupported timestamp type '{}': {}", type(self.timestamp).__name__, e)
    ...
    def local_datetime(self) -> datetime | None:
        """Converts the UTC datetime to the local timezone."""
