...
class ThemedIcons:
    ...
    def __init__(
        self, shape: Literal["SIMPLE", "CIRCLE", "SQUARE"] = "SIMPLE", outline: bool = False, alt: bool = False
    ) -> None:
...
class Icons:
    ...
    @classmethod
    def custom(
        cls, shape: Literal["SIMPLE", "CIRCLE", "SQUARE"] = "SIMPLE", outline: bool = False, alt: bool = False
    ) -> ThemedIcons:
