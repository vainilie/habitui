...
class ThemedIcons:
    ...
    def __init__(
        ...
        self.shape: Literal["SIMPLE", "CIRCLE", "SQUARE"] | None = (
            shape if shape != Literal["SIMPLE"] else None
        )
    ...
    def with_theme(
        ...
        new_shape: Literal["SIMPLE", "CIRCLE", "SQUARE"] = (
            shape if shape is not None else (self.shape or "SIMPLE")
        )
