...
class MinimalLogger:
    ...
    def setup(
        ...
        :param rotation: Log file rotation policy (e.g., "10 MB", "daily")
...
def setup_logging(
    console_level: str = "TRACE", file_level: str = "DEBUG", log_file: str = "app.log", **kwargs: str
) -> None:
    """
...
def add_textual_sink(textual_widget: Any, level: str = "TRACE") -> int:
    ...
    return logger.add(textual_sink, level=level, format="{message}")
