...
class DataVault:
    ...
    def _load_from_database(self, vault_type: VaultType) -> Any | None:
        """Load data from habitui.database vault.
        ...
        try:
            ...
            log.error("Failed to load {} data from habitui.database: {}", vault_type, str(e))

            return None

        else:
            if loaded_data:
                log.debug("{} data loaded successfully from habitui.database", vault_type.title())
    ...
    async def _get_game_content(self, mode: SaveStrategy, debug: bool, force: bool = False) -> None:
        ...
        try:
            ...
            if self.game_content:
                log.debug("Game content fetched, saved, and loaded from habitui.database")

            else:
                log.error("Failed to load game content from habitui.database after saving")
    ...
    async def _get_party_content(self, mode: SaveStrategy, debug: bool, force: bool = False) -> None:
        ...
        try:
            ...
            if self.party:
                log.debug("Party content fetched, saved, and loaded from habitui.database")

            else:
                log.error("Failed to load party content from habitui.database after saving")
    ...
    async def _get_user_data(self, mode: SaveStrategy, debug: bool, force: bool = False) -> None:
        ...
        try:
            ...
            if self.user:
                log.debug("User content fetched, saved, and loaded from habitui.database")

            else:
                log.error("Failed to load user content from habitui.database after saving")
    ...
    async def _get_tasks_data(self, mode: SaveStrategy, debug: bool, force: bool = False) -> None:
        ...
        try:
            ...
            if self.tasks:
                log.debug("Tasks content fetched, saved, and loaded from habitui.database")

            else:
                log.error("Failed to load tasks content from habitui.database after saving")
    ...
    async def _get_tags_data(self, mode: SaveStrategy, debug: bool, force: bool = False) -> None:
        ...
        try:
            ...
            if self.tags:
                log.debug("Tags content fetched, saved, and loaded from habitui.database")

            else:
                log.error("Failed to load tags content from habitui.database after saving")
    ...
    async def _get_challenges_data(self, mode: SaveStrategy, debug: bool, force: bool = False) -> None:
        ...
        try:
            ...
            if self.challenges:
                log.debug("Challenges content fetched, saved, and loaded from habitui.database")
