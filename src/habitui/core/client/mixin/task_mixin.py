...
from habitui.core.models import TaskType, Attribute, ScoreDirection, HabiTuiBaseModel, TaskCreatePayload
...
class TaskMixin:
	...
	async def get_user_tasks_raw_response(
		self,
		*,
		task_type_filter: TaskType | Literal["habits", "dailys", "todos", "rewards"] | None = None,
	) -> HabiticaResponse:
