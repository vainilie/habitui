# ♥♥─── API Models ───────────────────────────────────────────────────────────────
"""Defines Pydantic models for parsing generic API responses from Habitica."""
...
class HabiticaAPIError(Exception):
    ...
    def __str__(self) -> str:
        """Returns a string representation of the error, including available details."""
...
class HabiticaApiErrorDetail(BaseModel):
    """Represents detailed information about an error returned by the Habitica API."""
